      ...
      <div className=" flex flex-col items-center lg:flex-row justify-between mb-10 lg:mb-0">
        <div>
          ...
          <p className="mt-2 text-center lg:text-start">
            Tim kami terdiri dari para profesional yang berdedikasi tinggi, siap
            memberikan pelayanan terbaik dengan keahlian dan komitmen. Kami
            bangga dengan kualitas layanan yang kami tawarkan.
          </p>
        </div>
